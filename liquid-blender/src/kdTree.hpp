...
template <class VectorOfVectorsType, typename num_t = Float, int DIM = 4, class Distance = nanoflann::metric_L2, typename IndexType = size_t>
struct KDTreeVectorOfVectorsAdaptor
{
	...
	{
		buildTree(dimensionality, mat, leaf_max_size);
	}

	void buildTree(const int dimensionality, const VectorOfVectorsType &mat, const int leaf_max_size = 10) 
	{		
